...
* Faça o clone do repositório para um diretório da sua máquina
    ```
    git clone https://github.com/thaynnaraluciano/fcg-payment-api.git
    ```
* Acesse o diretório *fcg-payment-api*
    ```
    cd fcg-payment-api
    ```
* Abra a solution *PaymentService.sln* (disponível em: *fcg-payment-api*) com o Visual Studio.

## Escolhas de desenvolvimento

A aplicação foi separada em microsserviços, sendo este o microsserviço de pagamentos.
...
Foi utilizada função lambda para notificar o status dos pagamentos realizados pelo usuário.
